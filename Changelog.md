...
* The C# text-template client code generator now treats an initial assignment to `null` as a real change for nullable properties, while only adding the extra initialization tracking needed for those properties.
