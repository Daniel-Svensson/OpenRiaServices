...
Namespace TestNamespace
    ...
    Partial Public NotInheritable Class AuthenticationService1
        ...
        Public Interface IAuthenticationService1Contract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/AuthenticationService1/GetUser", ReplyAction:="http://tempuri.org/AuthenticationService1/GetUserResponse")>  _
            Function GetUser() As System.Threading.Tasks.Task(Of QueryResult(Of User1))
            ...
            <HasSideEffects(true),  _
             OperationContract(Action:="http://tempuri.org/AuthenticationService1/Login", ReplyAction:="http://tempuri.org/AuthenticationService1/LoginResponse")>  _
            Function Login(ByVal userName As String, ByVal password As String, ByVal isPersistent As Boolean, ByVal customData As String) As System.Threading.Tasks.Task(Of QueryResult(Of User1))
            ...
            <HasSideEffects(true),  _
             OperationContract(Action:="http://tempuri.org/AuthenticationService1/Logout", ReplyAction:="http://tempuri.org/AuthenticationService1/LogoutResponse")>  _
            Function Logout() As System.Threading.Tasks.Task(Of QueryResult(Of User1))
            ...
            <OperationContract(Action:="http://tempuri.org/AuthenticationService1/SubmitChanges", ReplyAction:="http://tempuri.org/AuthenticationService1/SubmitChangesResponse")>  _
    ...
    Partial Public NotInheritable Class AuthenticationService2
        ...
        Public Interface IAuthenticationService2Contract
            ...
            ''' <returns>The 'QueryResult' returned from the 'GetUser' operation.</returns>
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/AuthenticationService2/GetUser", ReplyAction:="http://tempuri.org/AuthenticationService2/GetUserResponse")>  _
            Function GetUser() As System.Threading.Tasks.Task(Of QueryResult(Of User2))
            ...
            ''' <returns>The 'QueryResult' returned from the 'Login' operation.</returns>
            <HasSideEffects(true),  _
             OperationContract(Action:="http://tempuri.org/AuthenticationService2/Login", ReplyAction:="http://tempuri.org/AuthenticationService2/LoginResponse")>  _
            Function Login(ByVal userName As String, ByVal password As String, ByVal isPersistent As Boolean, ByVal customData As String) As System.Threading.Tasks.Task(Of QueryResult(Of User2))
            ...
            ''' <returns>The 'QueryResult' returned from the 'Logout' operation.</returns>
            <HasSideEffects(true),  _
             OperationContract(Action:="http://tempuri.org/AuthenticationService2/Logout", ReplyAction:="http://tempuri.org/AuthenticationService2/LogoutResponse")>  _
            Function Logout() As System.Threading.Tasks.Task(Of QueryResult(Of User2))
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <OperationContract(Action:="http://tempuri.org/AuthenticationService2/SubmitChanges", ReplyAction:="http://tempuri.org/AuthenticationService2/SubmitChangesResponse")>  _
            Function BeginSubmitChanges(ByVal changeSet As IEnumerable(Of ChangeSetEntry), ByVal callback As AsyncCallback, ByVal asyncState As Object) As IAsyncResult
