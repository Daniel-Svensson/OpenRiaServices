    ...
    Partial Public NotInheritable Class AttributeThrowingDomainContext
        ...
        Public Interface IAttributeThrowingDomainServiceContract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/AttributeThrowingDomainService/GetThrowing", ReplyAction:="http://tempuri.org/AttributeThrowingDomainService/GetThrowingResponse")>  _
            Function GetThrowing(ByVal throwingQueryParam As Integer) As System.Threading.Tasks.Task(Of QueryResult(Of AttributeThrowingEntity))
            ...
            <HasSideEffects(true),  _
             OperationContract(Action:="http://tempuri.org/AttributeThrowingDomainService/InvokeThrowing", ReplyAction:="http://tempuri.org/AttributeThrowingDomainService/InvokeThrowingResponse")>  _
            Function InvokeThrowing(ByVal throwingInvokeParam As Integer) As System.Threading.Tasks.Task(Of Boolean)
            ...
            <OperationContract(Action:="http://tempuri.org/AttributeThrowingDomainService/SubmitChanges", ReplyAction:="http://tempuri.org/AttributeThrowingDomainService/SubmitChangesResponse")>  _
