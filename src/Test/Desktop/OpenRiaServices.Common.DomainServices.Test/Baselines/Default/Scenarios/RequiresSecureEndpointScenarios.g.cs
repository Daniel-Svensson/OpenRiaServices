...
namespace TestDomainServices
{
    ...
    public sealed partial class TestService_RequiresSecureEndpoint : DomainContext
    {
        ...
        public interface ITestService_RequiresSecureEndpointContract
        {
            ...
            [OperationContract(Action="http://tempuri.org/TestService_RequiresSecureEndpoint/GetTestEntities", ReplyAction="http://tempuri.org/TestService_RequiresSecureEndpoint/GetTestEntitiesResponse")]
            System.Threading.Tasks.Task<QueryResult<TestEntity_RequiresSecureEndpoint>> GetTestEntities();
        }
