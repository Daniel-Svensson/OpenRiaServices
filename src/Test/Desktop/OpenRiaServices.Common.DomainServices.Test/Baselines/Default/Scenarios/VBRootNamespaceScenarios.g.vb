...
Partial Public NotInheritable Class VBRootNamespaceTestDomainContext
    ...
    Public Interface IVBRootNamespaceTestDomainServiceContract
        ...
        <HasSideEffects(false),  _
         OperationContract(Action:="http://tempuri.org/VBRootNamespaceTestDomainService/M", ReplyAction:="http://tempuri.org/VBRootNamespaceTestDomainService/MResponse")>  _
        Function M() As System.Threading.Tasks.Task(Of QueryResult(Of VBRootNamespaceDomainObject))
        ...
        <HasSideEffects(false),  _
         OperationContract(Action:="http://tempuri.org/VBRootNamespaceTestDomainService/M4", ReplyAction:="http://tempuri.org/VBRootNamespaceTestDomainService/M4Response")>  _
        Function M4() As System.Threading.Tasks.Task(Of QueryResult(Of VBRootNamespaceDomainObject4))
    End Interface
...
Namespace Inner
    ...
    Partial Public NotInheritable Class VBRootNamespaceTestProviderInsideInner
        ...
        Public Interface IVBRootNamespaceTestProviderInsideInnerContract
            ...
            ''' <returns>The 'QueryResult' returned from the 'M' operation.</returns>
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/VBRootNamespaceTestProviderInsideInner/M", ReplyAction:="http://tempuri.org/VBRootNamespaceTestProviderInsideInner/MResponse")>  _
            Function M() As System.Threading.Tasks.Task(Of QueryResult(Of VBRootNamespaceDomainObjectInsideInner))
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/VBRootNamespaceTestProviderInsideInner/M1", ReplyAction:="http://tempuri.org/VBRootNamespaceTestProviderInsideInner/M1Response")>  _
            Function M1() As System.Threading.Tasks.Task(Of QueryResult(Of VBRootNamespaceDomainObject3))
        End Interface
...
Namespace VBRootNamespaceTest2
    ...
    Partial Public NotInheritable Class VBRootNamespaceTestDomainService2
        ...
        Public Interface IVBRootNamespaceTestDomainService2Contract
            ...
            ''' <returns>The 'QueryResult' returned from the 'M' operation.</returns>
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/VBRootNamespaceTestDomainService2/M", ReplyAction:="http://tempuri.org/VBRootNamespaceTestDomainService2/MResponse")>  _
            Function M() As System.Threading.Tasks.Task(Of QueryResult(Of VBRootNamespaceDomainObject2))
        End Interface
