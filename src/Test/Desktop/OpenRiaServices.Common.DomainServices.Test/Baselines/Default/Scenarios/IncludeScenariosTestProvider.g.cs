...
namespace TestDomainServices
{
    ...
    public sealed partial class IncludeScenariosTestProvider : DomainContext
    {
        ...
        public interface IIncludeScenariosTestProviderContract
        {
            ...
            [OperationContract(Action="http://tempuri.org/IncludeScenariosTestProvider/GetAs", ReplyAction="http://tempuri.org/IncludeScenariosTestProvider/GetAsResponse")]
            System.Threading.Tasks.Task<QueryResult<IncludesA>> GetAs();
        }
