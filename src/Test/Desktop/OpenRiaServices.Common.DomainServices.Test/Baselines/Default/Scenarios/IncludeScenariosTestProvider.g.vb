    ...
    Partial Public NotInheritable Class IncludeScenariosTestProvider
        ...
        Public Interface IIncludeScenariosTestProviderContract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/IncludeScenariosTestProvider/GetAs", ReplyAction:="http://tempuri.org/IncludeScenariosTestProvider/GetAsResponse")>  _
            Function GetAs() As System.Threading.Tasks.Task(Of QueryResult(Of IncludesA))
        End Interface
