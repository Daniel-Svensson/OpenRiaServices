...
namespace TestDomainServices
{
    ...
    public sealed partial class AttributeThrowingEntity : Entity
    {
        ...
        private bool _nonThrowingPropertyInitialized;
        ...
        private bool _throwingPropertyInitialized;
        ...
        public string ThrowingProperty
        {
            ...
            set
            {
                if (((this._throwingProperty != value) 
                            || (this._throwingPropertyInitialized == false)))
                {
                    ...
                    this._throwingPropertyInitialized = true;
