...
namespace TestDomainServices
{
    ...
    public sealed partial class AttributeThrowingDomainContext : DomainContext
    {
        ...
        public interface IAttributeThrowingDomainServiceContract
        {
            ...
            [OperationContract(Action="http://tempuri.org/AttributeThrowingDomainService/GetThrowing", ReplyAction="http://tempuri.org/AttributeThrowingDomainService/GetThrowingResponse")]
            System.Threading.Tasks.Task<QueryResult<AttributeThrowingEntity>> GetThrowing(int throwingQueryParam);
            ...
            [HasSideEffects(true)]
            [OperationContract(Action="http://tempuri.org/AttributeThrowingDomainService/InvokeThrowing", ReplyAction="http://tempuri.org/AttributeThrowingDomainService/InvokeThrowingResponse")]
            System.Threading.Tasks.Task<bool> InvokeThrowing(int throwingInvokeParam);
            ...
            [OperationContract(Action="http://tempuri.org/AttributeThrowingDomainService/SubmitChanges", ReplyAction="http://tempuri.org/AttributeThrowingDomainService/SubmitChangesResponse")]
