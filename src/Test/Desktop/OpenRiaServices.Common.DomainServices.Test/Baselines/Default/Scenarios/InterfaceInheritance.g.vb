    ...
    Partial Public NotInheritable Class InterfaceInheritanceDomainContext
        ...
        Public Interface IInterfaceInheritanceDomainServiceContract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/InterfaceInheritanceDomainService/EntityWithXElement_Get", ReplyAction:="http://tempuri.org/InterfaceInheritanceDomainService/EntityWithXElement_GetRespon"& _ 
                "se")>  _
            Function EntityWithXElement_Get() As System.Threading.Tasks.Task(Of QueryResult(Of EntityWithXElement))
            ...
            <OperationContract(Action:="http://tempuri.org/InterfaceInheritanceDomainService/SubmitChanges", ReplyAction:="http://tempuri.org/InterfaceInheritanceDomainService/SubmitChangesResponse")>  _
