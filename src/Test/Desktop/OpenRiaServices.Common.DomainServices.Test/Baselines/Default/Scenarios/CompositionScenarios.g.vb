...
Namespace TestDomainServices
    ...
    Partial Public NotInheritable Class CompositionScenarios_Explicit
        ...
        Public Interface ICompositionScenarios_ExplicitContract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/CompositionScenarios_Explicit/GetParents", ReplyAction:="http://tempuri.org/CompositionScenarios_Explicit/GetParentsResponse")>  _
            Function GetParents() As System.Threading.Tasks.Task(Of QueryResult(Of Parent))
            ...
            <OperationContract(Action:="http://tempuri.org/CompositionScenarios_Explicit/SubmitChanges", ReplyAction:="http://tempuri.org/CompositionScenarios_Explicit/SubmitChangesResponse")>  _
    ...
    Partial Public NotInheritable Class CompositionScenarios_Various
        ...
        Public Interface ICompositionScenarios_VariousContract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/CompositionScenarios_Various/GetChildren", ReplyAction:="http://tempuri.org/CompositionScenarios_Various/GetChildrenResponse")>  _
            Function GetChildren(ByVal parentID As Integer) As System.Threading.Tasks.Task(Of QueryResult(Of CompositionScenarios_Child))
            ...
            ''' <returns>The 'QueryResult' returned from the 'GetParents' operation.</returns>
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/CompositionScenarios_Various/GetParents", ReplyAction:="http://tempuri.org/CompositionScenarios_Various/GetParentsResponse")>  _
            Function GetParents() As System.Threading.Tasks.Task(Of QueryResult(Of CompositionScenarios_Parent))
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/CompositionScenarios_Various/GetSelfReferencingComposition_One"& _ 
                "ToManys", ReplyAction:="http://tempuri.org/CompositionScenarios_Various/GetSelfReferencingComposition_One"& _ 
                "ToManysResponse")>  _
            Function GetSelfReferencingComposition_OneToManys() As System.Threading.Tasks.Task(Of QueryResult(Of SelfReferencingComposition_OneToMany))
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/CompositionScenarios_Various/GetSelfReferencingCompositions", ReplyAction:="http://tempuri.org/CompositionScenarios_Various/GetSelfReferencingCompositionsRes"& _ 
                "ponse")>  _
            Function GetSelfReferencingCompositions() As System.Threading.Tasks.Task(Of QueryResult(Of SelfReferencingComposition))
            ...
            ''' <param name="asyncState">Optional state object.</param>
            ''' <returns>An IAsyncResult that can be used to monitor the request.</returns>
            <OperationContract(Action:="http://tempuri.org/CompositionScenarios_Various/SubmitChanges", ReplyAction:="http://tempuri.org/CompositionScenarios_Various/SubmitChangesResponse")>  _
            Function BeginSubmitChanges(ByVal changeSet As IEnumerable(Of ChangeSetEntry), ByVal callback As AsyncCallback, ByVal asyncState As Object) As IAsyncResult
