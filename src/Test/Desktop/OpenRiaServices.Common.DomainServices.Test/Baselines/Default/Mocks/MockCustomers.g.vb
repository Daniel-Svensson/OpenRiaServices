    ...
    Partial Public NotInheritable Class MockCustomerDomainContext
        ...
        Public Interface IMockCustomerDomainServiceContract
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/MockCustomerDomainService/GetCustomers", ReplyAction:="http://tempuri.org/MockCustomerDomainService/GetCustomersResponse")>  _
            Function GetCustomers() As System.Threading.Tasks.Task(Of QueryResult(Of MockCustomer))
            ...
            <HasSideEffects(false),  _
             OperationContract(Action:="http://tempuri.org/MockCustomerDomainService/GetReports", ReplyAction:="http://tempuri.org/MockCustomerDomainService/GetReportsResponse")>  _
            Function GetReports() As System.Threading.Tasks.Task(Of QueryResult(Of MockReport))
            ...
            <OperationContract(Action:="http://tempuri.org/MockCustomerDomainService/SubmitChanges", ReplyAction:="http://tempuri.org/MockCustomerDomainService/SubmitChangesResponse")>  _
